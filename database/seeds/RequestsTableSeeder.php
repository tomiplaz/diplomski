...
class RequestsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Request::create([
            ...
            'start_timestamp' => Carbon\Carbon::create(2016, 8, 11, 8, 0, 0),
            'end_timestamp' => Carbon\Carbon::create(2016, 8, 30, 15, 0, 0),
            'duration' => "19 dana i 7 sati",
            'advance_payment' => 780,
